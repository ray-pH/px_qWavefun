...
`;
let ss_Tunneling = `let energy = 60;
...
`;
const ss_TwoParticle = `let energy = 40;
...
renderOpt.scalePotential = 8e-5;
`;
const ss_boxBasis = ` // Increase step per Frame if movement is too slow
let L = 0.8;
let n_state = 3;
